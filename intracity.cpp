...
int main()
{
    ...
    bool flag_shower = false; // useless flag
    ...
    while (!init) {
        ...
        case 1: cityscape(); // Intro:  Chapter 1
            if (know) {
                textdisplay("(You awaken, surrounded by familiar scenery. You are lying on a sidewalk, in the downtown area of the city. No signs of life are visible anywhere. Again, excluding the broken cars and the debris that lines the streets, the city is pristine, almost as if stuck in time.");
                ignoreinput();
                textdisplayreg("(You remember your name. It was " + player.name + ". You decide to move. You have a job to do.");
            }
            else {
                textdisplay("(You awaken, surrounded by unfamiliar scenery. You are lying on a sidewalk, in what appears to be the downtown area of a city. No signs of life are visible anywhere. Excluding the broken cars and the debris that lines the streets, the city is pristine, almost as if stuck in time."); textdisplayblue("[When you see a green dash, press ENTER to continue!]");
                ignoreinput();
                textdisplayreg("(You try to think of who you are and how you got here, but your mind is empty. After thinking a while, you rise to your feet as you decide to explore the city.)");
            }
            textdisplay("(After 10 minutes of walking through generic buildings and empty shops, you notice the first sign of civilization since you woke up. It's a car with a large number 4 painted on its side. Investigate the car?)"); textdisplayblue("1. Yes |  2. Ignore it [Enter a number to choose. Entering a number other than those listed will default the choice to the final one.]");
            ...
            if (choice1 == "1") {
                ...
                yellowtext("???: ");  textdisplayreg("Hey! What are you doing to that car!");
            }
            else {
                textdisplayreg("(You choose to ignore the car. As you turn around, you hear the sound of someone calling to you.)");
                yellowtext("???: ");  textdisplayreg("Hey, who are you?");
            }

            if (know) {
                textdisplayreg("(You turn around and see a young woman wearing a modified police uniform and gripping a small firearm. It's Tot. Any identifying information on her gear is scratched off, replaced with patches sewn with the number 4 and the university seal. For a split second, her eyes full of killing intent made you genuinely fear for your life. Her face calms as she notices you have a face.)");
            }
            else { textdisplayreg("(You turn around and see a young woman wearing a modified police uniform and gripping a small firearm. Any identifying information on her gear is scratched off, replaced with patches sewn with the number 4 and a strange seal. Her stressed face calms when she looks at your face for some reason.)"); }
            ...
            yellowtext("Patroller: ");  textdisplayreg("So that's how it is. Well this might sound strange, but do you remember anything about your life? Like... your name, maybe?");
            ...
            if (name.empty()) { //Special dialogue 1
                ...
                else { textdisplayreg("(It's no use. No matter how hard you try, you can't remember your name."); }
                ...
                yellowtext("Patroller: ");  textdisplayreg("That's a problem. If you have no memories, it makes it harder to assign you a position. (Suddenly, her face lights up.) Hey, how about I give you a name?");
                textdisplayreg("(You have no reason to refuse, but her excitement worries you.)");
                youtext2(); textdisplayreg("That's fine.");
                yellowtext("Patroller: ");  textdisplayreg("Wonderful! A name huh.... (She takes a long look at you.....) How about... " + player.name + "?");
                flag_jade = true;
                ...
                textdisplayreg("(You grab a strand of hair from your shoulder and take a look at it. You didn't notice before, but she was right.)");
                ...
                yellowtext("Patroller: ");  textdisplayreg("Usually people manage to remember basic things about themselves and only themselves, like their skills and past jobs. It's a bit strange to see someone who doesn't remember anything at all. At least, that what I was told when I woke up. I didn't remember anything either. It's nice seeing someone who's just like me. (She seems pleased to have found a comrade.)");
                textdisplayreg("(You were about to thank her and ask her name before she suddenly interrupts.)");
            }
            else {
                player.name = name;
                if (!know) {
                    firstname = name; // If the flag for true ending is not unlocked, name will not be remembered next playthrough
                }
                youtext2(); textdisplayreg("My name is..." + player.name + ".");
                textdisplayreg("(You notice her face change in surprise at your answer.)");
                yellowtext("Patroller: ");  textdisplayreg("You actually remember your name? Thats... unexpected. Most of us don't remember our names when we wake up. If you remember your name, do you remember anything else? Like your job, family, friends?");
                if (know) {
                    textdisplayreg("(You resist the urge to give away any important information. You should probably avoid getting her involved for the time being.....)");
                }
                else { textdisplayreg("(You are overwhelmed by her constant questioning.)"); }
                yellowtext("Patroller: ");  textdisplayreg("Oh, sorry. I'm asking a lot from someone who just woke up aren't I? But this is really important, I promise.");
                if (!know) { textdisplayreg("(You think about it again, but it's useless. You really can't remember anything besides your name.)"); }
                youtext2(); textdisplayreg("Sorry. I can't remember anything at all.");
                textdisplayreg("(She is visibly disappointed.)");
                yellowtext("Patroller: ");  textdisplayreg("Oh. Well, thats still better than most of us. Ah, I guess I should explain everything to you now. For about a month now, people have been suddenly appearing in streets around the city without their memories, just like you. Of course, that includes me as well.");
            ...
            yellowtext("Patroller: ");  textdisplayreg("By the way, people who just wake up are given a job based on their skills. My job as patrol is to find new people and return them to the university. There, they recieve a name based on their skills, a job, and a dorm room. We are not paid money, but we all work together to survive.");
            ...
            textdisplayreg("(A new life in this unfamiliar city...... According to her, a society has been formed despite this strange situation. Wait... monsters!?)");
        ...
        case 2: youtext2(); textdisplayreg("I want to stay with you."); //Chapter 2a:
            ...
            if (!know) {
                ...
                youtext2(); textdisplayreg("We're not taking the car?");
                yellowtext("Patroller: ");  textdisplayreg("The car? That thing doesn't work. We have the keys for it, so it's used for storage. But it doesn't start.");
                youtext2(); textdisplayreg("That's disappointing.");
                yellowtext("Patroller: ");  textdisplayreg("Well, not like there's anywhere to go. We're locked inside the city. Beyond the highways are where the monsters live. They're called mimics, because they look like people without the face.");
                youtext2(); textdisplayreg("That sounds terrifying.");
                yellowtext("Patroller: ");  textdisplayreg("Well that's what we're for. And the Highway Guard, of course.");
            }
            else {
            ...
            chartext(tot);  textdisplayreg("Of course not! I think. Since I didn't remember my name, I had the Professor name me. He named me that because I was the shortest at the time.");
            youtext2(); textdisplayreg("At the time? Is there someone shorter than you now?");
            chartext(tot);  textdisplayreg("(.....)");
            chartext(tot);  textdisplayreg("L-Look, we're already here. (She points at the University. It's big enough to be a town on it's own.)");
            chartext(tot);  textdisplayreg("Let's go in.");
            textdisplayreg("(You follow Tot into the University square. There are stalls, some full of food and others with supplies. You see a flashy man dressed in a lab coat talking to a woman dressed in a combat medic uniform, also patched with the number 4.)");
            chartext(tot);  textdisplayreg("Hey! Professor! I got one!");
            textdisplayreg("(Am I a fish?)");
            ...
            if (flag_jade) {
                ...
                chartext(professor);  textdisplayreg("Again? Tot. I've already told you. You shouldn't-");
                ...
                chartext(professor);  textdisplayreg("(He's clearly surprised.) What? You remembered? That's interesting.");
            }
        ...
        case 3:yellowtext("Medic: ");  textdisplayreg("Good for you, Tot. And you, " + player.name + ".");
            ...
            yellowtext("Medic: ");  textdisplayreg("Come on, I already told you not to call me that. " + player.name + ", don't pay any attention to her. My name is Akia. I was a biology student in my past life. I named myself originally, but Tot made me change it.");
            chartext(tot);  textdisplayreg("Because your old name wasn't cute at all.");
            ...
            textdisplayreg("(You begin walking to the dorms with the 2 girls. They seem to get along well, which is impressive for people who only met a month ago. You envy their relationship.)");
            ...
            chartext(aki); textdisplayreg("We're here. Our room is 270. It's the biggest one.");
            ...
            textdisplayreg("(They're roommates.)");
            chartext(aki); textdisplayreg("(She opens the door.) Come on in. We should have room for one more.");
            youtext2(); textdisplayreg("Thank you.");
            textdisplayreg("(The room is decently spacious. There are 2 small beds in the room, a desk near the window, and a sleeping bag on the floor.)");
            chartext(aki); textdisplayreg("Alright. You can take the second bed with Tot.");
            chartext(tot);  textdisplayreg("Huh?");
            textdisplay("(Tot is making a face you can't quite make out. Is she excited or is she mad? You choose to....)"); textdisplayblue("1. Sleep on the bed | 2. Sleep on the floor   ");
            choice3b = userinput();
            if (choice3b == "1") {
                youtext2(); textdisplayreg("Alright. I'll sleep on the bed.");
                chartext(tot);  textdisplayreg("!!!");
                ...
                textdisplayreg("(You feel a familiar killing intent from behind. You choose not to look.)");
            }
            ...
            if (flag_shower) { textdisplayreg("(You follow the girls to the dorm bathroom. The showers are individual yet again...)"); }
            else { textdisplayreg("(You follow the girls to the dorm bathroom. The showers are individual.)"); }
            textdisplayreg("(After finishing up, you meet up with the girls back at the dorm. As soon as you open the door, they start staring at you. Tot expression is incomprehensible.)");
            ...
            youtext2(); textdisplayreg("Thank you very much.");
            chartext(aki); textdisplayreg("Let's go to sleep. I heard Professor's planning something big tomorrow.");
            ...
            if (choice3b == "1") {
                ...
                youtext2(); textdisplayreg("I'm glad you were the one who found me.");
        ...
        case 4: textdisplayreg("(You wake up from the sound of someone talking in their sleep. Unexpectedly, it's Akia.)");
            ...
            textdisplayreg("(She wraps Tot in her blanket and rolls her on the floor. She rolls quite far.)");
            chartext(aki); textdisplayreg("A burrito is perfect for a potato like you. Wake up already.");
            textdisplayreg("(Akia gets irritated in the mornings, huh. Not that you're one to talk.)");
            chartext(tot);  textdisplayreg("...huh? Oh! (She rises incredibly fast!)");
            chartext(tot);  textdisplayreg("Good morning!");
            ...
            if (choice6a == "1") {
                ...
                chartext(tot);  textdisplayreg("You joke, but at this point I'm pretty sure that's true. Those things are smarter than they look. They used to charge at us, but now they only attack people who get too close. Stay away and you'll be fine. Oh, it's done.");
                textdisplayreg("(She opens the ration bag and starts nibbling a strange-looking cracker thing like a hampster. You decide to join her and grab a ration bag from the table. You pour water into it and it finishes cooking after a few minutes.)");
                textdisplayreg("(It's a strange mush. It tastes like chicken.....)");
                ...
                textdisplayreg("(You continue eating. Seriously, what is this? It ain't bad.)");
            }
            else {
                textdisplayreg("(You enter a room labeled 'REC ROOM'. You see Akia messing with a strange device on a desk.)");
                ...
                textdisplayreg("(You wander around the Rec Room. You notice a framed picture of Tot, Akia, and an girl you've never met. They're posing by the car you passed earlier.)");
                ...
                youtext2(); textdisplayreg("Thinking like that isn't healthy. Don't blame yourself.");
            ...
            chartext(professor); textdisplayreg("I think you're perfect for my plan today. Someone new like you shouldn't have any attachment to the current government. The thing is, I want to overthrow the President.");
            textdisplayreg("(A revolution on the second day!?)");
            youtext2(); textdisplayreg("And what do you want me to do?");
            chartext(professor); textdisplayreg("I want you to explore the library. There's something in there I want. I had forgotten about it, but I suddenly remembered when I saw you. There's an unused room in there full of maps. Check them for something useful. That's your assignment. Of course, Akia and Tot will join you. I would do it myself, if I was capable of fighting those monsters.");
            textdisplayreg("(You don't have the power nor care enough to refuse his offer.)");
            youtext2(); textdisplayreg("Ok. Got it.");
            chartext(professor); textdisplayreg("Good. Ah, here they come. I'll speak to you again in the evening. (He leaves as Akia and Tot arrive.)");
        ...
        case 5: lib: textdisplayreg("(You gear up and arrive at the library. It's a nice looking but abandoned building.)");
            ...
            chartext(tot);  textdisplayreg("Also, watch out for mimics. Aki's a medic, but she can't treat those disgusting wounds they cause.");
            ...
            if (choice4a == "1") {
                ...
                textdisplayreg("(You see Akia kill the mimic and rush to your aid, but it's too late. You lose consciousness. Is this really how it ends?)");
                gameover();
                if (userinput() == "1") {
                    goto lib;
                }
            ...
            textdisplayreg("(You return to the square. The professor comes up and asks you to visit the capitol with your team to ask the President a final time about leaving. You agree, and take off toward the capitol.)");
            checkpoint = 6;
            break;

        case 6: capitolbreak: textdisplayreg("(You arrive at the capitol, a fancy building close to the University. In front are armed guards, who let you in when you say you have a message for the President.)");
            chartext(tot);  textdisplayreg("Even the inside is fancy.");
            textdisplayreg("You climb some stairs and reach the President's office.");
            ...
            chartext(secretary); textdisplayreg("Haha. That's not the train password. That the password to the memory unlocker on President's computer, you idiots!........ah");
            chartext(chief); textdisplayreg("You dumbass.");
            textdisplayreg("(You and Akia share a moment of complete understanding as you turn to look at each other. You......)"); textdisplayred("1. Make a run for the computer  | 2. Don't do anything  ");
            choice5a = userinput();
            if (choice5a == "1") {
                textdisplay("(You both make a run for the computer. The secretary tries to stop you, but Akia holds her back. The President is too stunned to even try. The computer lights up. On it, a simple phrase: "); textdisplayblue("[ENTER PASSWORD]:");
                password2 = userinput();
                if (password2 == "csci1370") {
                    ...
                    textdisplayreg("(You get in with Tot and Akia. The train moves by itself, as if it was magic. Somehow, the sky seems to clear as well. Before you know it, the city behind you disappears.)");
                    ...
                    if (flag_jade) {
                        ...
                        textdisplayreg("(She grabs your hand and rests her head on your shoulder. Despite the successful escape, she doesn't look satisfied at all.)");
                    ...
                    textdisplayreg("(The President menacingly walks up to you casually stabbing you in the chest!)");
                ...
                textdisplayreg("(As you run, you hear the rumbling sound of patrol units nearby. You don't care what they're doing. You just want to be happy. With Tot and Akia. Unfortunately for you, your life is about to get a whole lot harder.)");
        ...
        case 7:chapter2b: youtext2(); textdisplayreg("I'll head for the highway to become a Guard."); //Chapter 2b: 
            ...
            yellowtext("Patroller: ");  textdisplayreg("Take this. If you encounter one of those monsters, kill it with this. They are quick, if you hesitate for even a second you'll die. I'll ask you one more time. Are you sure you want to go?");
            ...
            if (choice3a == "1") { // Game over 1
                ...
                textdisplayreg("In the front of the camp are armored guards talking to a young man dressed in a military uniform with a sniper rifle hanging from his back. He and the guards all have large patches sewn with yet another seal. You walk up to them. The man in the uniform notices you as you interrupt his conversation.");
                yellowtext("Man in Uniform: ");  textdisplayreg("Huh? Who are you?");
                textdisplayreg("(He walks up to you.)");
                yellowtext("Man in Uniform: ");  textdisplayreg("You're patchless. Did you just wake up?");
                ...
                yellowtext("Man in Uniform: ");  textdisplayreg("The monsters that live beyond the highway that surrounds the inner city. I'm sure you've heard of them. They just spawn in, like us. They look like normal humans too, until you see their faces at least. They have no facial features at all. Their real brains are actually lower in their bodies, in their chest.");
                ...
                chartext(hunter);  textdisplayreg("Who gave you that name?");
                if (flag_jade) { //Special dialogue 3
                    youtext2(); textdisplayreg("A patrol member named me before I came here. I couldn't remember my name or past job.");
                    ...
                    youtext2(); textdisplayreg(" I don't know. It's my real name. I remembered it when I woke up. Nothing else though.");
                ...
                yellowtext("Large Man: ");  textdisplayreg(player.name + "? Well, I won't pry. My name is Riot. I'm Captain Hunter's second in command. I was a cop or something in my past life. I'll be escorting you to your station along with Hunter. We've cleared out most of them, but there are some buildings that still have mimics in them.");
                youtext2(); textdisplayreg("Thanks, but why is Hunter coming?");
                chartext(riot);  textdisplayreg("Boredom, I'd assume. You can't leave the city because of those mimics, but they've been docile lately. Most of our issues now are with food supplies, which Hunter has no control over. In fact, none of us do.");
                ...
                chartext(riot);  textdisplayreg("They get dropped to us from the sky in the middle of the night. No one knows who does it, or where the stuff comes from. The problem recently, is that while the population grows, our supplies stay consistant. There's already been fights breaking out at the University over who gets what. Basically, if we can't find a way to leave the city or get more food, we're screwed. And before you ask, no, mimics aren't edible.");
                ...
                chartext(riot);  textdisplayreg("If you ask me, I think this is a game. We're probably being watched by some sick bastard who enjoys suffering. Either that, or we're in hell. And it's all downhill from here.");
                textdisplayreg("(Riot starts preparing to sleep. You think about his words as you tuck yourself into your sleeping bag.)");
        ...
        case 8: textdisplayreg("(You awaken, surrounded by.... familiar scenery. And the extremely loud sound of an alarm. You hear loud groans coming from Riot's sleeping bag before he finally wakes up.)");
            ...
            chartext(hunter);  textdisplayreg("Finally awake, huh? We're leaving in an hour. Go freshen up in the barracks. (He hands you a uniform.)");
            youtext2(); textdisplayreg("Where's that?");
            textdisplayreg("(Hunter points at a hotel-like building near the side of the highway. A bridge leading to one of the top floor windows has been made, converting it into a door.)");
            ...
            textdisplayreg("(The shower room was just that. You see naked men walking around, getting ready for their day. Because this is the only room with running water, the women and men have seperate shower times. Now was the men's time.)");
            if (know) {
            ...
            chartext(riot);  textdisplayreg("Hey. I don't know what your deal is, but you sure you're fine showing that to everyone?");
            textdisplayreg("(You give him a confused look.)");
            chartext(riot);  textdisplayreg("You didn't notice?. Look in the mirror.");
            ...
            textdisplayreg("(You notice your uniform fits disturbingly perfectly. How did Hunter know your size.....? There are some things you're better off not knowing, you think to yourself.)");
            ...
            youtext2(); textdisplayreg("Then why choose it?");
            chartext(hunter);  textdisplayreg("Cuz it's tall. Come on, you can handle it.");
            checkpoint = 9;
            break;

            //Lookout Building chapter
        case 9: Lookout: youtext2(); textdisplay("You walk inside the building. A large lobby greets you. There's an elevator that obviously doesn't work. There are stairs, and a strange room near the back."); textdisplayred("You choose to investigate the.... 1. The strange room | 2. The stairs ");
            choice5b = userinput();
            if (choice5b == "1") {
                textdisplay("You start walking toward the room, with Riot and Hunter following closely behind. You open the door, to see a office room. It has a desk in the middle. It seems this was an office building.");
            ...
            choice6b = userinput();
            if (choice6b == "1") {
                textdisplayreg("(You remember what Hunter told you. You shoot at the mimic's chest. The monster writhes in pain, and you shoot it once more to end it. Hunter and Riot had killed theirs as well.)");
                ...
                if (flag_airfield) {
                    ...
                    chartext(hunter);  textdisplayreg("We also explored the area marked 'Detonator'. We found a bunch of strange boxes full of explosives under the highway that I could've sworn weren't there before. There was also a button that I assume blows everything up. No idea what good blowing up our base would do, but I don't feel like finding out.");
                ...
                chartext(hunter);  textdisplayreg("Apparently there's trouble at the university. Someone's started a riot. Most of my men are busy dicking around at the airfield. Go check it out and report back in the evening.");
                youtext2(); textdisplayreg("Got it.");
                textdisplayreg("(Hunter hangs up. You pack your things and leave the building. You find a bike leaning on the side of a building. From reading the map, you remember where the University is. You take the bike and ride it there.)");
                checkpoint = 10;
        ...
        case 10: universityhunter:textdisplayreg("(You reach the University. It's a large area, almost like it could be it's own town. From the distance you hear gunshots, along with screams. You hurry to the main square.)");
            ...
            yellowtext("Patrol member: "); textdisplayreg("Huh? Oh, a highway guard. (He scoffs at you.) You guys wouldn't get it. That corrupt hag treats you like her babies. She doesn't give a crap about any of us in the Patrol. We're starving, and we've had enough. Tonight, we're raiding the capitol.");
        ...
        case 11: capitolhunter:
            ...
            chartext(secretary); textdisplayreg("Pres!!!");
            chartext(chief); textdisplayreg("Ugh... fine. There's a password that if entered into that computer, will unlock everyone's memories.");
            chartext(professor); textdisplayreg("Memories? That's it?");
            chartext(chief); textdisplayreg("That's it.");
            ...
            chartext(professor); textdisplayreg("Then, does anybody here know it? Speak up or the President dies.");
            ...
            if (password == "csci1370" && know) {
                ...
                textdisplayreg("(The professor quickly types the password in. It works. For a moment, the world turns bright. Everyone stops and stares into space, as if they realized something horrible.)");
                textdisplayreg("(You look around the room. The atmosphere is deathly cold. It's a familiar feeling.)");
                chartext(professor); textdisplayreg("Holy crap.... my... my family....we ...we need to leave!");
                textdisplayreg("(Everyone has the same thought, except for the President.)");
                chartext(chief); textdisplayreg("Not so fast. (She prepares to lunge at you and the professor, but you are quicker.)");
                textdisplayreg("(You know exactly what she is. You point your gun straight at her chest. After all, she's just like you.)");
                chartext(secretary); textdisplayreg("Wait! Don't hurt her!");
                textdisplayreg("(Before you can shoot, the secretary rushes to protect the President.)");
                ...
                chartext(tot); textdisplayreg("Already got it working.");
                ...
                textdisplayreg("(Everyone rushed to the train. Including the President and her secretary. For a moment, everyone forgot about killing each other. The sky was suddenly bright, as if hours had passed in a second.)");
                textdisplayreg("(You arrive at the train station and enter, along with nearly everyone in the city. Others, including Hunter and Riot, boarded the planes in the airfield. You take a seat with Tot and Akia.)");
                ...
                textdisplayreg("(She holds both your and Akia's hands and turns towards you.)");
                chartext(tot); textdisplayreg("Congratulations for breaking the cycle and surviving, my cute student.");
                textdisplayreg("(A higher power.....you realize what you were feeling and respond the only way you know how. The way you were programmed to.)");
                ...
                textdisplayreg("(You hear two loud bangs. One of them killing the President, and the other killing the secretary.)");
                chartext(professor); textdisplayreg("Well boys, we did it.");
                textdisplayreg("(You hear the loud cheering of the patrol members.)");
                chartext(professor); textdisplayreg("Finally, we are free from the tyranny of the old President! From now on, I'll be in charge, along with a new cabinet. I'll rule for the people, and find a way out of this hell!");
                textdisplayreg("(The cheering grows louder. You decide to leave, and notify Hunter.)");
                chartext(hunter); textdisplayreg("They killed the President!? Jesus, I didn't think that professor was that crazy. But as shitty as that is, I have more bad news to tell you. Mimics can fly. And take down planes. We can't leave the city. Just one thing after another, isn't it?");
                ...
                if (flag_airfield) {
                    ...
                    youtext2(); textdisplayreg("Sorry, but I'm leaving here alive. See you.");
                    ...
                    textdisplayreg("(Your board the helicopter. The blades of the chopper spin, and before you know it, you're 400 meters above ground. The city looks truly beautiful as you fly into a uncertain future. Was this the right decision? Could things have turned out differently? It didn't matter. You're alive.)");
                    ...
                    chartext(hunter); textdisplayreg("I'm staying. I'll try to convince Professor to let me live. I'm a valuable asset aren't I? Haha.");
                    textdisplayreg("(You think it's amazing how Hunter can laugh at a time like this.)");
                    youtext2(); textdisplayreg("I'll help you.");
                    chartext(hunter); textdisplayreg("Thanks, " + player.name + ".");
                    youtext2(); textdisplayreg("Still. Thank you Hunter. You're amazing.");
                    chartext(hunter); textdisplayreg("Huh? .. yeah I guess, haha....... Anyway, I'll see you later.");
                    textdisplayreg("(You walk back to the capitol and meet Hunter. Somehow you two manage to stay alive, despite Hunter's reputation for being a suck-up to the President. You stay in the city, battling the mimics and starvation with Hunter and his squad, who were made into Patrol members after the Highway Guard was dissolved. Your earn a reputation as a marksman and quickly climb the ranks of the patrol. This is your life now. Could it have been better? You don't know. But you're alive.)");
